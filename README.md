...
> Άνοιγμα αυτής της σελίδας στο [https://mkasapakis.github.io/first/](https://mkasapakis.github.io/first/)
...
* αναζήτηση για **https://github.com/mkasapakis/first** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/mkasapakis/first/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/mkasapakis/first** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/mkasapakis/first/raw/master/.github/makecode/blocks.png)
